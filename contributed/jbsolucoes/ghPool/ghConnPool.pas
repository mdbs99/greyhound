...
uses
  SyncObjs, SysUtils, Classes, DB, LCLIntf, LCLType, LMessages,
...
constructor TghConnectionPool.Create(PoolSize: integer = 20;
  CleanupDelayMinutes: integer = 10; Timeoutms: LargeInt = 10000);
var
...
function TghConnectionPool.GetConnection(JSONDBConf: string; var ConnID: integer = 0): IConnection;
var
  i: integer;
